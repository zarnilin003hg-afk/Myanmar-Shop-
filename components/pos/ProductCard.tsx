...
export const ProductCard: React.FC<ProductCardProps> = React.memo(({ product, addToCart }) => {
  ...
  return (
    <div
      className="rounded-xl shadow-md p-4 cursor-pointer bg-white transition-all duration-200 hover:transform hover:-translate-y-1 hover:shadow-lg"
    ...
    >
      ...
      <div className="text-sm mb-2 text-gray-500">{product.category}</div>
      <div className="flex justify-between items-center">
        <div className="text-xl font-bold text-blue-500">{product.price.toLocaleString()} ကျပ်</div>
        <div
